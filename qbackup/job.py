...
class Job:
    ...
    def execute(self, wait = True):
        ...
        self._future = runner.Runner.getInstance().submitJob(self)
...
class runtask(object):
    ...
    def __call__(self, clsJob):
        runner.Runner.getInstance().registerJob(self._clsTask, clsJob)
        return clsJob
...
def job(clsTask):
    ...
    def toDecorate(f):
        ...
        runner.Runner.getInstance().registerJob(clsTask, WrapJob)
